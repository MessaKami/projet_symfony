...
// #[UniqueEntity(fields: ['Tel'], message: 'Digage tu as le meme numero que quelqu\un')]
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(mappedBy: 'user', targetEntity: Offence::class)]
    ...
    public function removeOffence(Offence $offence): static
    {
        if ($this->offences->removeElement($offence)) {
            ...
            if ($offence->getUser() === $this) {
                $offence->setUser(null);
            }
        }
